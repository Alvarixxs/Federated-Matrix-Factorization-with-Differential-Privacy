...
def main(args):
    ...
    print(f"Entrenando FL en {args.dataset} (k={args.k}, lr={args.lr}, reg={args.reg}, rounds={args.rounds}, local_epochs={args.local_epochs})")
    history_train, history_val = server.train(clients, training_data_per_user, val_data=val_data)
