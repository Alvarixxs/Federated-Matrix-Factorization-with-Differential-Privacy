...
# ==========================================================
# ❗ Inicializar variables VACÍAS (sin defaults)
# ==========================================================
...
python -m src.evaluation.extract_scores \
    --dataset "$DATASET" \
    --model "FL" \
    --k "$K" \
    --lr "$LR" \
...
python -m src.attacks.build_mia_dataset \
    --dataset "$DATASET" \
    --model "FL" \
    --seed "$SEED" \
    --k "$K" \
...
python -m src.attacks.mia_threshold \
    --dataset "$DATASET" \
    --model "FL" \
    --k "$K" \
    --lr "$LR" \
...
python -m src.attacks.mia_classifier \
    --dataset "$DATASET" \
    --model "FL" \
    --k "$K" \
    --lr "$LR" \
...
echo "🎉 MIA completado finalizado."
